...
export default function NotFound() {
  return (
    <>
      {/* component */}
      <Navbar />
      <div className="flex w-full  flex-col items-center justify-center space-x-8 space-y-16 py-32 lg:flex-row lg:space-y-0 2xl:space-x-0">
        <div className="flex w-full flex-col items-center justify-center text-center lg:w-1/2 lg:px-2 xl:px-0">
          ...
          <Link
            href="/"
            className=" flex gap-2 rounded-md bg-lime-500 px-6 py-3 text-sm font-bold hover:bg-lime-600"
            title="Return Home"
          >
            <svg
